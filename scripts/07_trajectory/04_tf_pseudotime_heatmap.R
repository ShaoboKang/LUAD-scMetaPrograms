# ============================================================================
# Script: 04_tf_pseudotime_heatmap
# Module: 07_trajectory
# Description:
#   ClusterGVis heatmap and trajectory visualization of TF activities
#   along Monocle3 pseudotime with custom branch and pseudotime annotations.
#   Produces Figure 6E-F from the manuscript.
# ============================================================================
...
#' Run ClusterGVis trajectory analysis
#'
...
#' @return List with cluster objects and plot.
run_clustergvis_trajectory <- function(
  ...
  pdf(file.path(output_fig_dir, "monocle3_tf_with_heatmapAnnotation.pdf"),
      height = 12, width = 10, onefile = FALSE)
  ...
  message("ClusterGVis trajectory analysis complete.")
  return(list(ck = ck, ck1 = ck1, anno = anno))
}
# ---- Entry Point ----
if (!interactive()) {
  message("[INFO] Running analysis pipeline...")
  run_clustergvis_trajectory()
}
